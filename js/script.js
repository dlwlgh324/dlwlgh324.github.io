...
$(document).ready(function () {
    ...
    var photoshop = new ProgressBar.Line('#Photo-skill', {
        strokeWidth: 4,
        easing: 'easeInOut',
        duration: 1400,
        color: '#8e9aad',
    ...
    var illust = new ProgressBar.Line('#illust-skill', {
        strokeWidth: 4,
        easing: 'easeInOut',
        duration: 1400,
        color: '#8e9aad',
    ...
    var html = new ProgressBar.Line('#html-skill', {
        strokeWidth: 4,
        easing: 'easeInOut',
        duration: 1400,
        color: '#8e9aad',
    ...
    var css = new ProgressBar.Line('#css-skill', {
        strokeWidth: 4,
        easing: 'easeInOut',
        duration: 1400,
        color: '#8e9aad',
    ...
    var java = new ProgressBar.Line('#java-skill', {
        strokeWidth: 4,
        easing: 'easeInOut',
        duration: 1400,
        color: '#8e9aad',
    ...
    var jquery = new ProgressBar.Line('#jquery-skill', {
        strokeWidth: 4,
        easing: 'easeInOut',
        duration: 1400,
        color: '#8e9aad',
    ...
    $(window).scroll(function () {
        ...
        if (sc_y >= 2700) {
            java.animate(0.7); // Number from 0.0 to 1.0
            jquery.animate(0.7); // Number from 0.0 to 1.0
            css.animate(0.8); // Number from 0.0 to 1.0
            html.animate(0.8); // Number from 0.0 to 1.0
            photoshop.animate(0.9); // Number from 0.0 to 1.0    
            illust.animate(0.9); // Number from 0.0 to 1.0
        } else {
            java.animate(0); // Number from 0.0 to 1.0
            ...
            illust.animate(0); // Number from 0.0 to 1.0
        }

    });

    //퍼블리싱 슬라이드
    let sw_work = new Swiper('.sw-work', {
        loop: true,
        effect: "fade",
        autoplay: {
            delay: 2700,
